  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = $userdata->register($username, $name, $password, $re_password, $tel, $licenseplate);
            ...
            <div class="col-sm-6 col-sm-offset-3 form-box">
              ...
              <div class="form-bottom">
                <form method="POST">
                  ...
                  <div class="form-group">
                    <label class="sr-only" for="tel">Phone Number</label>
                    <input type="text" name="tel" placeholder="Phone Number..." class="form-username form-control" id="tel" required>
                  </div>
                  <div class="form-group">
                    <label class="sr-only" for="licenseplate">Car License</label>
                    <input type="text" name="licenseplate" placeholder="License Plate..." class="form-username form-control" id="licenseplate" required>
                  </div>
                  <div class="p-t-10">
